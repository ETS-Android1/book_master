package com.example.book_master_2.ui.home;
...
import com.example.book_master_2.Adapter.articleadapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        recyclerAdapter = new articleadapter(getContext(), atricledata);
                                    ...
                                    if(innerJObject.has("revisions")){
                                        ...
                                        for (int ai = 0; ai < myListsAll.length(); ai++) {
                                            ...
                                            if (localdb.GetVbyID_Sync(innerJObject.getString("pageid")).getCount() > 0) {
                                                ...
                                                localdb.insert(innerJObject.getString("title"), desc, innerJObject.getString("pageid"),
    ...
    private void SetDataToadapter(String data_of_continue) {
        if (!conn_check.isConnectionAvailable(context)) {
            localdb.open();
            Cursor cursor = localdb.GetAll("ART");
